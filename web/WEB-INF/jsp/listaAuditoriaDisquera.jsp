<%-- 
    Document   : listaAuditoriaDisquera
    Created on : 31/03/2022, 06:56:32 PM
    Author     : Raúl
--%>
...
<head>
    ...
    <!-- Estilos -->
    <title>Lista Cambios Disquera</title>
    ...
    <div class="container mt-4">
        ...
        <div class="card">
            <div class="card-header bg-success">
                <h4>Lista General de Cambios Disquera</h4>
                <div style="float: right">
                    <a class="btn btn-outline-light" href="listaDisquera.htm">Ver Registros</a>
                </div>
