<%-- 
    Document   : editarArtistaTieso
    Created on : 5/11/2022, 12:06:26 AM
    Author     : Raúl
--%>
            ...
            <div class="card">
                <div class="card-header bg-success">
                    ...
                    <div style="float: right">
                        <a class="btn btn-outline-light" href="editarArtista.htm?idArtista=${Lista[0].idArtista}">Artista Vivo</a>
                    </div>
                </div>
                <div class="card-body bg-dark">
                    <form method="POST">
                        ...
                        <input type="date" name="FechaDefuncion" class="form-control" required value="${Lista[0].fechaDefuncion}"/>
