<%-- 
    Document   : GeneraQRDisquera
    Created on : 23/03/2022, 12:30:00 AM
    Author     : alex-
--%>
...
<head>
    ...
    <!-- Estilos -->
    <title>Codigo QR Disquera</title>
        ...
        <div class="card">
            ...
            <div class="card-body bg-dark">
                <form method="POST">
                    ...
                    <label>Foto</label><br>
                    <img src="${Lista[0].Imagen}" style="width: 400px;" alt="Imagen"><br>

                    <br><a href="listaDisquera.htm" class="btn btn-outline-success">Regresar</a>
                </form>
            </div>
        </div>
    </div>
