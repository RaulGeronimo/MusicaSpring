<%-- 
    Document   : listaDisquera
    Created on : 14/03/2022, 07:18:49 PM
    Author     : Lemus
--%>
        ...
        <div class="card">
            <div class="card-header bg-success text-white">
                ...
                <div style="float: left">
                    <a class="btn btn-outline-light" href="altaDisquera.htm">Agregar Registro</a>
                </div>
                <div style="float: right">
                    <a class="btn btn-outline-light" href="listaAuditoriaDisquera.htm">Vista de Cambios</a>
                </div>
            </div>
                    ...
                    <tbody>
                        <c:forEach var="dato" items="${Lista}">
                            <tr>
                                ...
                                <td>
                                    <a href="editarDisquera.htm?idDisquera=${dato.idDisquera}" class="btn btn-warning">
                                    ...
                                    <a href="eliminarDisquera.htm?idDisquera=${dato.idDisquera}"
                                    ...
                                    <a href="GeneraQRDisquera.htm?idDisquera=${dato.idDisquera}"
...
<script src="js/exportarDisquera.js"></script>
