<%-- 
    Document   : listaArtista
    Created on : 12/03/2022, 06:27:10 PM
    Author     : Raúl
--%>
        ...
        <div class="card">
            <div class="card-header bg-success text-white">
                ...
                <div style="float: right">
                    <a class="btn btn-outline-light" href="listaAuditoriaArtista.htm">Vista de Cambios</a>
                </div>
                <div style="float: left">
                    <a class="btn btn-outline-light" href="altaArtista.htm">Agregar Registro</a>
                </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="media">
                                        ...
                                        <!--<img src="data:image/png;base64,'.base64_encode(${dato.Imagen}).'">-->
                                    </div>
                                </td>
                                <td>${dato.Estado}</td>
                                <td>
                                    <a href="editarArtista.htm?idArtista=${dato.idArtista}" class="btn btn-warning">
                                    ...
                                    <a href="eliminarArtista.htm?idArtista=${dato.idArtista}"
                                    ...
                                    <a href="GeneraQRArtista.htm?idArtista=${dato.idArtista}" class="btn btn-success">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
...
<script src="js/exportarArtista.js"></script>
