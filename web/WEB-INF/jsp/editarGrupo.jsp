<%-- 
    ...
    Created on : 14/03/2022, 08:15:34 PM
    Author     : Lemus
--%>
        ...
        <div class="card">
            ...
            <div class="card-body bg-dark">
                <form method="POST">
                    ...
                    <label>IdDisquera</label>
                    <select id="Disquera" name="idDisquera" class="form-select" required>
                        <option selected value="${Lista[0].idDisquera}">${ListaGrupo[0].Disquera}
                        </option>
                        <option disabled value="">Selecciona una Disquera</option>
                    ...
                    <label>Origen</label>
                    <input type="text" name="Origen" class="form-control" value="${Lista[0].Origen}" required />

                    <label>Inicio</label>
                    <input type="date" name="Inicio" class="form-control" value="${Lista[0].Inicio}" required />

                    <label>No Integrantes</label>
                    <input type="number" name="NoIntegrantes" class="form-control" value="${Lista[0].NoIntegrantes}"
                        required />
                    ...
                    <label>Imagen</label>
                    <input type="url" name="imagen" class="form-control" placeholder="URL de una imagen" required value="${Lista[0].Imagen}">
