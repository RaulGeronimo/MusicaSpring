<%-- 
    Document   : listaAuditoriaAlbum
    Created on : 31/03/2022, 06:56:07 PM
    Author     : Raúl
--%>
...
<head>
    ...
    <!-- Estilos -->
    <title>Lista Cambios Album</title>
    ...
    <div class="container mt-4">
        ...
        <div class="card">
            <div class="card-header bg-success">
                <h4>Lista General de Cambios Album</h4>
                <div style="float: right">
                    <a class="btn btn-outline-light" href="listaAlbum.htm">Ver Registros</a>
                </div>
