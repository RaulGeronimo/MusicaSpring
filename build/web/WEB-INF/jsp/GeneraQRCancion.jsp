<%-- 
    Document   : GeneraQRCancion
    Created on : 22/03/2022, 11:17:17 PM
    Author     : alex-
--%>
        ...
        <div class="card">
            ...
            <div class="card-body bg-dark">
                <form method="POST">
                    ...
                    <label>Artista</label>
                    <input type="text" name="idArtista" class="form-control"
                    ...
                    <br><a href="listaCancion.htm" class="btn btn-outline-success">Regresar</a>
                </form>
            </div>
        </div>
    </div>
