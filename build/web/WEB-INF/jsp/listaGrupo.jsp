<%-- 
    Document   : listaGrupo
    Created on : 14/03/2022, 08:06:24 PM
    Author     : Lemus
--%>
    ...
    <div class="container mt-4">
        ...
        <div class="card">
            <div class="card-header bg-success text-white">
                <h4>Lista General Grupo</h4>
                <div style="float: left">
                    <a class="btn btn-outline-light" href="altaGrupo.htm">Agregar Registro</a>
                </div>
                <div style="float: right">
                    <a class="btn btn-outline-light" href="listaAuditoriaGrupo.htm">Vista de Cambios</a>
                </div>
            </div>
                    ...
                    <tbody>
                        <c:forEach var="dato" items="${Lista}">
                            <tr>
                                ...
                                <td>
                                    <a href="editarGrupo.htm?idGrupo=${dato.idGrupo}" class="btn btn-warning">
                                    ...
                                    <a onclick="return confirm('¿Estás seguro que deseas eliminar el registro?')"
                                        href="eliminarGrupo.htm?idGrupo=${dato.idGrupo}" class="btn btn-danger">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                    ...
                                    <a href="GeneraQRGrupo.htm?idGrupo=${dato.idGrupo}" class="btn btn-success">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
...
<script src="js/exportarGrupo.js"></script>
