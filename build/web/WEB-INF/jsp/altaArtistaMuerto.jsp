<%-- 
    Document   : altaArtistaMuerto
    Created on : 4/11/2022, 11:57:34 PM
    Author     : Raúl
--%>
            ...
            <div class="card">
                <div class="card-header bg-success">
                    ...
                    <div style="float: right">
                        <a class="btn btn-outline-light" href="altaArtista.htm">Artista Vivo</a>
                    </div>
                </div>
                <div class="card-body bg-dark">
                    <form method="POST">
                        <label>Nombre</label>
                        <input type="text" name="nombre" class="form-control" placeholder="Nombre del Artista" required onfocus/>
                        ...
                        <label>Fecha Difucion</label>
                        <input type="date" name="FechaDefuncion" class="form-control" required/>

                        <label>Pais</label>
                        <select name="pais" class="form-select" aria-label="Default select example" required>
                            <option selected disabled value="">Selecciona el Pais de Origen</option>
                        ...
                        <select name="instrumento" class="form-select" aria-label="Default select example" required>
                            <option selected disabled value="">Instrumento que toca</option>
                        ...
                        <input type="text" name="estatura" class="form-control" placeholder="Estatura en Metros" required />
