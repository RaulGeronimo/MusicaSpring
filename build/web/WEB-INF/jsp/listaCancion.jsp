<%-- 
    Document   : listaCancion
    Created on : 16/03/2022, 08:28:07 AM
    Author     : SALA 2-14
--%>
    ...
    <div class="container mt-4">
        ...
        <div class="card">
            <div class="card-header bg-success text-white">
                <h4>Lista General Canción</h4>
                <div style="float: left">
                    <a class="btn btn-outline-light" href="altaCancion.htm">Agregar Registro</a>
                </div>
                <div style="float: right">
                    <a class="btn btn-outline-light" href="listaAuditoriaCancion.htm">Vista de Cambios</a>
                </div>
            </div>
                    ...
                    <tbody>
                        <c:forEach var="dato" items="${Lista}">
                            <tr>
                                ...
                                <td>${dato.Album}</td>
                                <td>${dato.Grupo}</td>
                                <td>${dato.Interprete}</td>
                                <td>${dato.Duracion}</td>
                                <td>${dato.Lanzamiento}</td>
                                <td>${dato.Idioma}</td>
                                <td>${dato.Genero}</td>
                                <td>
                                    <a href="editarCancion.htm?idCancion=${dato.idCancion}" class="btn btn-warning">
                                    ...
                                    <a onclick="return confirm('¿Estás seguro que deseas eliminar el registro?')"
                                        href="eliminarCancion.htm?idCancion=${dato.idCancion}" class="btn btn-danger">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                    ...
                                    <a href="GeneraQRCancion.htm?idCancion=${dato.idCancion}" class="btn btn-success">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
...
<script src="js/exportarCancion.js"></script>
