<%-- 
    Document   : editarAlbum
    Created on : 14/03/2022, 11:02:33 AM
    Author     : SALA 2-14
--%>
    ...
    <div class="container mt-4">
        ...
        <div class="card">
            <div class="card-header bg-success">
                <h3>Actualiza Album</h3>
            </div>
            <div class="card-body bg-dark">
                <form method="POST">
                    <label>Nombre</label>
                    <input type="text" name="nombre" class="form-control" placeholder="Nombre del Album"
                        value="${Lista[0].Nombre}" required autofocus />

                    <label>Grupo</label>
                    <select id="Grupo" name="idGrupo" class="form-select" required>
                        <option selected value="${Lista[0].idGrupo}">${ListaAlbum[0].Grupo}</option>
                    ...
                    <input type="number" name="NoCanciones" placeholder="Total de Canciones que contiene el album"
                        class="form-control" value="${Lista[0].NoCanciones}" required />
                    ...
                    <label>Ventas</label>
                    <input type="number" placeholder="Número de Ventas" name="noVentas" class="form-control"
                        value="${Lista[0].NoVentas}" required />
                    ...
                    <label>Imagen</label>
                    <input type="url" name="imagen" class="form-control" placeholder="URL de una imagen"
                        value="${Lista[0].Imagen}" required>
...
<script>
    ...
    var soptions = $('#Grupo option:not(:first)').sort(function (a, b) {
        return a.text == b.text ? 0 : a.text < b.text ? -2 : 2
    });
